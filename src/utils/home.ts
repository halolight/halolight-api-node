...
<head>
  ...
  <meta name="description" content="HaloLight API - 基于 Express 5 + TypeScript + Prisma 的企业级后端服务">
    ...
    <div class="max-w-7xl mx-auto px-6">
      <div class="max-w-3xl">
        <div class="inline-flex items-center gap-2 px-4 py-2 bg-slate-800/80 border border-slate-700/50 rounded-full text-sm text-slate-400 mb-6">
          <span class="text-green-500">🟢</span> Enterprise-Grade Node.js Backend Service
        </div>
        <h1 class="text-4xl md:text-6xl font-extrabold leading-tight mb-6">
          轻量高效 Node.js API<br>
          <span class="text-gradient">Express 5 驱动</span>
        </h1>
        <p class="text-xl text-slate-400 leading-relaxed mb-8">
          基于 Express 5 + TypeScript + Prisma 的企业级后端服务，提供完整的 JWT 双令牌认证、RBAC 权限管理，
        ...
        <div class="flex flex-col sm:flex-row gap-4 mb-12">
          ...
          <a href="https://halolight.docs.h7ml.cn/guide/api-node" class="inline-flex items-center justify-center gap-2 px-7 py-4 bg-slate-800/80 text-white font-semibold rounded-xl border border-slate-700/50 hover:border-primary hover:bg-slate-800 transition-all" target="_blank">
            📚 在线使用指南
          </a>
        ...
        <div class="flex flex-wrap gap-3 pt-8 border-t border-slate-700/50">
          <div class="flex items-center gap-2 px-4 py-2 bg-slate-800/80 border border-slate-700/50 rounded-lg text-sm text-slate-400">
            <span>🟢</span> Node.js 20
          </div>
          <div class="flex items-center gap-2 px-4 py-2 bg-slate-800/80 border border-slate-700/50 rounded-lg text-sm text-slate-400">
            <span>⚡</span> Express 5
          </div>
          <div class="flex items-center gap-2 px-4 py-2 bg-slate-800/80 border border-slate-700/50 rounded-lg text-sm text-slate-400">
            <span>🔷</span> TypeScript 5
          </div>
          <div class="flex items-center gap-2 px-4 py-2 bg-slate-800/80 border border-slate-700/50 rounded-lg text-sm text-slate-400">
            <span>🔺</span> Prisma 6
          </div>
    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="p-8 bg-slate-800/50 border border-slate-700/50 rounded-2xl transition-all card-hover">
          ...
          <p class="text-slate-400 leading-relaxed">使用 Zod 自动验证请求数据，确保数据完整性和安全性。</p>
        </div>
        <div class="p-8 bg-slate-800/50 border border-slate-700/50 rounded-2xl transition-all card-hover">
          <div class="w-12 h-12 flex items-center justify-center bg-gradient-brand rounded-xl text-2xl mb-5">🐳</div>
      ...
      <div class="relative p-16 bg-gradient-brand rounded-3xl overflow-hidden">
        <div class="relative text-center">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/docs" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-green-600 font-semibold rounded-xl hover:shadow-xl transition-all">
              📖 Swagger 文档
            </a>
  ...
  <footer class="py-12 border-t border-slate-700/50">
    <div class="max-w-7xl mx-auto px-6 text-center">
      <div class="flex flex-wrap justify-center gap-8 mb-6">
        ...
        <a href="https://github.com/halolight/halolight-api-node/issues" target="_blank" class="text-slate-400 hover:text-white text-sm transition-colors">问题反馈</a>
      </div>
      <p class="text-slate-400 text-sm">
        Built with ❤️ by <a href="https://github.com/h7ml" target="_blank" class="text-green-400 hover:underline">h7ml</a> |
        Powered by Express 5 & Prisma ORM
      </p>
      <p class="text-slate-500 text-sm mt-2">
        Version 1.0.0 | Environment: ${environment}
      </p>
    </div>
  </footer>
</body>
...
export const getHealthResponse = () => ({
  ...
  database: 'Use /api/health/database to check database connection',
});
